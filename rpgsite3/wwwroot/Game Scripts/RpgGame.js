    ...
    var BattleState = (function (_super) {
        ...
        BattleState.prototype.CreateEnemies = function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                nextPriority++;
                //Monster creeren
                var monster = new RpgGame.Unit(this.game, nextPriority, 1, startX, this.game.world.centerY, "enemy" + data[i].id);
        ...
        BattleState.prototype.ShowPlayer = function () {
            ...
            RpgGame.speler.y = this.game.world.centerY;
