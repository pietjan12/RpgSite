    ...
    public class NewsFactory : INewsFactory
    {
        ...
        public INewsContext ChangeType(StorageType type)
        {
            ...
            if(type == StorageType.Sql) {
                ...
                INewsContext context = services.FirstOrDefault(o => o.GetType() == typeof(NewsSqlContext));
                if(context != null) {
                    return context;
                } else {
                ...
                INewsContext context = services.FirstOrDefault(o => o.GetType() == typeof(NewsMemoryContext));
                if (context != null) {
                    return context;
                }
                else {
