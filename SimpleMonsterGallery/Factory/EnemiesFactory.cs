    ...
    public class EnemiesFactory : IEnemiesFactory
    {
        ...
        public IEnemiesContext ChangeType(StorageType type)
        {
            ...
            if (type == StorageType.Sql)
            {
                ...
                IEnemiesContext context = services.First(o => o.GetType() == typeof(EnemiesSqlContext));
                if (context != null)
                {
                    return context;
                }
            ...
            {
                IEnemiesContext context = services.First(o => o.GetType() == typeof(EnemiesMemoryContext));
                if (context != null)
                {
                    return context;
                }
