    ...
    public class AccountFactory : IAccountFactory
    {
        ...
        public IAccountContext ChangeType(StorageType type)
        {
            ...
            if (type == StorageType.Sql)
            {
                ...
                IAccountContext context = services.First(o => o.GetType() == typeof(AccountSqlContext));
                if (context != null)
                {
                    return context;
                }
            ...
            {
                IAccountContext context = services.First(o => o.GetType() == typeof(AccountMemoryContext));
                if (context != null)
                {
                    return context;
                }
