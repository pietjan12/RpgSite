    ...
    public class CharacterFactory : ICharacterFactory
    {
        ...
        public ICharacterContext ChangeType(StorageType type)
        {
            ...
            if (type == StorageType.Sql)
            {
                ...
                ICharacterContext context = services.FirstOrDefault(o => o.GetType() == typeof(CharacterSqlContext));
                if (context != null)
                {
                    return context;
                }
            ...
            {
                ICharacterContext context = services.FirstOrDefault(o => o.GetType() == typeof(CharacterMemoryContext));
                if (context != null)
                {
                    return context;
                }
